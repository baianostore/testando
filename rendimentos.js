...
module.exports = {
    ...
    run: async(client, message, args) => {
      if(message.author.id !== `${perms.get(`${message.author.id}_id`)}`) return message.reply(`<a:No:1069123947897036880> | Você não está na lista de pessoas!`)
      ...
      const embed = new Discord.MessageEmbed()
        .setTitle(`${config.get(`title`)} | Rendimentos das vendas`)
        .addField(`<:caixa:1093295940951093259> | Status hoje:`, `Vendas realizadas: ${hojepedidos || "0"} \n<:Carteira:1099970324080103494> | Dinheiro arrecadado: R$ ${hojerecebimentos || "0"}`, false)
        .addField(`<:caixa:1093295940951093259> | Status 7 dias:`, `Vendas realizadas: ${setedias || "0"} \n<:Carteira:1099970324080103494> | Dinheiro arrecadado: R$ ${setediasrec || "0"}`, false)
        .addField(`<:caixa:1093295940951093259> | Status 30 dias:`, `Vendas realizadas: ${setedias2 || "0"} \n<:Carteira:1099970324080103494> |Dinheiro arrecadado: R$ ${setediasrec2 || "0"}`, false)
